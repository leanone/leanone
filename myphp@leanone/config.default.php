 ...
 * characters.
 */
$cfg['blowfish_secret'] = 'testleanone';
...
$cfg['Servers'][$i]['user']          = 'jixie62';      // MySQL user
$cfg['Servers'][$i]['password']      = '34h7akec';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'jixie62';          // If set to a db-name, only
